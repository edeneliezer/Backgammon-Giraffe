	...
	*/
	...
	private void initImages() {
		...
		for (int i = 0; i < cubeSides.length; i++) {
			...
			try {
				InputStream input1 = getClass().getResourceAsStream("/game/img/double_cube/" + side + ".png");
				InputStream input2 = getClass().getResourceAsStream("/game/img/double_cube/" + side + "_highlighted.png");
