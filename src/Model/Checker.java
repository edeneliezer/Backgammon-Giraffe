...
public class Checker extends ImageView implements ColorParser, Touchable {
	...
	private void initImg(boolean isIcon) {
		...
		InputStream input1 = getClass().getResourceAsStream("/game/img/checkers/" + colorString + "_checkers.png");
		InputStream input2 = getClass().getResourceAsStream("/game/img/checkers/" + colorString + "_checkers_highlighted.png");
